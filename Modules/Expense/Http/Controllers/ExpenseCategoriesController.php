...
class ExpenseCategoriesController extends Controller
{
    ...
    public function update(Request $request, ExpenseCategory $expenseCategory) {
        ...
        toast('Kategori Pengeluaran berhasil diupdate!', 'info');
    ...
    public function destroy(ExpenseCategory $expenseCategory) {
        ...
        if ($expenseCategory->expenses()->count() > 0) {
            return back()->withErrors('Kategori belum dihapus karena masih ada pengeluaran yang terhubung dengan kategori ini.');
        }

        $expenseCategory->delete();

        toast('Kategori Pengeluaran berhasil dihapus!', 'warning');
