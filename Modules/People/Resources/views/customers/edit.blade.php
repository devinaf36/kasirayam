                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="customer_phone">No.Telp/Whatsapp <span class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="Kota" required value="{{ $customer->Kota }}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="Kelurahan">Kelurahan <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="Kelurahan" required value="{{ $customer->Kelurahan }}">
                                    </div>
                                </div>
                            </div>
