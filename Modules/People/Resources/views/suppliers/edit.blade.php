                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="Kota" required value="{{ $supplier->Kota }}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="Kelurahan">Kelurahan <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="Kelurahan" required value="{{ $supplier->Kelurahan }}">
                                    </div>
                                </div>
                            </div>
