...
class CategoriesController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        toast('Kategori Produk berhasil dibuat!', 'success');
    ...
    public function update(Request $request, $id) {
        ...
        toast('Kategori Produk berhasil diupdate!', 'info');
    ...
    public function destroy($id) {
        ...
        if ($category->products()->exists()) {
            return back()->withErrors('Kategori belum dihapus karena masih ada produk yang terhubung dengan kategori ini.');
        }

        $category->delete();

        toast('Kategori Produk berhasil dihapus!', 'warning');
