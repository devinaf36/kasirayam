                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_cost">Modal Per Kemasan <span class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_stock_alert">Ingatkan untuk Restok jika Sisa Stok Kurang Dari <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_tax_type" id="product_tax_type">
                                            ...
                                            <option {{ $product->product_tax_type == 1 ? 'selected' : '' }}  value="1">PPN</option>
                                            <option {{ $product->product_tax_type == 2 ? 'selected' : '' }} value="2">Lainnya</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_unit">Unit <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Satuan akan diletakkan setelah jumlah produk."></i> <span class="text-danger">*</span></label>
                                        <select class="form-control" name="product_unit" id="product_unit" required>
                                            <option value="" selected >Satuan Unit</option>
